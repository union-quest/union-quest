...
<section class="py-2 px-4 text-center">
  <div class="max-w-auto md:max-w-lg mx-auto">
    ...
    <div class="max-w-md mx-auto pt-1 mt-5 space-y-3 md:mt-8 md:space-y-5">
      <div class="space-y-5 sm:flex sm:justify-center sm:space-y-0 sm:space-x-3">
        ...
        <NavButton
          blank={true}
          class="big secondary"
          href="https://github.com/wighawag/union-quest"
    ...
    <div class="pt-3 pb-4 dark:bg-black bg-white">
      ...
      <code id="union-quest-command" on:click={select} class="mb-5 text-pink-600 font-black"
        >npx degit wighawag/union-quest your-app-folder</code
      >
      <p class="mt-6 text-gray-500">
        Find out more on
        <a class="underline" href="https://github.com/wighawag/union-quest#readme" target="_blank" rel="noopener"
          >github</a
        >
      </p>
    </div>
  ...
  <div class="pt-16 relative max-w-7xl mx-auto">
    <div class="text-center">
      ...
      <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 dark:text-gray-400 sm:mt-4">
        Here are examples of apps built using union-quest
      </p>
    </div>
